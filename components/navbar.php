...
<div class="site-header-main tm-wrap container-fullwide tm-container-for-header">
   <div class="site-branding tm-wrap-cell">
      <div class="headerlogo themetechmount-logotype-image tm-stickylogo-no">
         <h1 class="site-title">
            <a class="home-link" href="index.html" title="Demo2" rel="home">
               <span class="tm-sc-logo tm-sc-logo-type-image">
                  <noscript>
                     <img class="themetechmount-logo-img standardlogo" alt="Demo2" src="wp-content/uploads/custom/WhatsApp Image 2024-05-02 at 5.06.29 PM.jpeg">
                  </noscript>
                  <img class="lazyload themetechmount-logo-img standardlogo" alt="Demo2" src="wp-content/uploads/custom/WhatsApp Image 2024-05-02 at 5.06.29 PM.jpeg">
               </span>
            </a>
         </h1>
         <h2 class="site-description">Jungle Safari WordPress Theme</h2>
      </div>
   </div>
   <!-- .site-branding -->
      ...
      <nav id="site-navigation" class="main-navigation" aria-label="Primary Menu" data-sticky-height="95">
         <div class="tm-header-text-area">
            <div class="header-info-widget">
               <div class="classic-full-button"><a href="buy-ticket/index.html">Get a Tickets</a></div>
               <!-- <div class="call-us-now">
                  <div class="icon-box">
                  	<i class="kw_wilddale flaticon-call-center-agent tm-skincolor"></i>    
                  </div>  
                  <div class="title-box">
                  	<span class="tm-textcolor-white tm-text-des">Free Appointment</span>
                  	<h3 class="tm-skincolor">123 456 7890</h3>
                  </div>
                  </div> -->
            </div>
         </div>
         ...
         <div class="nav-menu">
            <ul id="menu-main-menu" class="nav-menu">
               <li id="menu-item-113" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-113">
                  ...
                  <!-- <ul class="sub-menu">
                     <li id="menu-item-10926" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-10926"><a href="index.html" aria-current="page">Demo Two</a></li>
                     </ul> -->
               </li>
               <li id="menu-item-9753" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9753">
                  ...
                  <ul class="sub-menu">
                     <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="our-story.php">Our Story</a></li>
                     <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="why-travel-with-us.php">Why Travel With Us</a></li>
					 <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="our-missions.php">Our Mission</a></li>
					 <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="our-work.php">Our Work</a></li>
					 <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="gallery.php">Gallery</a></li>
					 <li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="terms-and-conditions.php">Terms & Conditions</a></li>
                  </ul>
               </li>
